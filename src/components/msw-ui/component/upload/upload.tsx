...
export const Upload = (props: {callBack: (data: string) => void; btnText?: string; btnStyle?: React.CSSProperties}) => {
  const {callBack, btnText, btnStyle} = props;
  ...
  const handleUpload = (e: any) => {
    ...
    if (file) {
      ...
      reader.onload = function (evt: ProgressEvent<FileReader>) { //读取完文件之后会回来这里
